...
func Builtins() *Registry {
	...
	registry, err := NewRegistry(
		...
		openAIImagesAdapter(), grokImagesAdapter(), xaiImagesAdapter(), arkImagesAdapter(), jimengImagesAdapter(), geminiImagesAdapter(),
...
// xAI 官方图片协议：执行引擎在 provider.go 的 runXAIImageTask（legacy 分发），
// 这里只注册元数据让协议校验、能力归类和公网参考图要求（RequiresPublicMediaURLs）可见。
func xaiImagesAdapter() Adapter {
	info := metadata("xai-image", "xAI 官方图片", "xAI", CapabilityImage, "POST /v1/images/generations", "", "application/json")
